...
public class GiaodienThem extends javax.swing.JFrame {
    ...
    private void themXeActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String thoiGianVao = namVao + "-" + thangVao + "-" + ngayVao;
        ...
        String thoiGianRoi = namRoi + "-" + thangRoi + "-" + ngayRoi;

        boolean isValidDate = isValidDate(ngayVao, thangVao, namVao) && isValidDate(ngayRoi, thangRoi, namRoi);

        if (isValidDate) {
            LocalDate timeIn = LocalDate.of(Integer.parseInt(namVao), Integer.parseInt(thangVao), Integer.parseInt(ngayVao));
            LocalDate timeOut = LocalDate.of(Integer.parseInt(namRoi), Integer.parseInt(thangRoi), Integer.parseInt(ngayRoi));

            Parking parking = new Parking(tenChuXe, bienSoXe, timeIn, timeOut);
